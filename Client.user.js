// ==UserScript==
// @name         🔒 MTurk Earnings Report (Full CSV Sync - Once Per Day)
...
(async () => {
  ...
  const todayDate = new Date().toLocaleDateString('en-CA', { timeZone: 'Asia/Kolkata' }); // e.g. 2025-10-30
  ...
  await GM_setValue(todayKey, todayDate); // record sync date
