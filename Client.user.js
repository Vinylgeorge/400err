// ==UserScript==
// @name         🔒 MTurk Earnings Report (Tampermonkey Compatible)
...
(function() {
  ...
  async function main() {
    ...
    const FIRESTORE_JS = 'https://www.gstatic.com/firebasejs/10.12.0/firebase-firestore-compat.js';
    ...
    // Load Firebase scripts dynamically (Tampermonkey safe)
    ...
    await loadScript(FIREBASE_APP_JS);
    await loadScript(FIRESTORE_JS);
    ...
    await db.collection('earnings_logs').doc(data.workerId).set(mergedData, { merge: true });
